# python scriptdl.py --subject=993675 --out_dir="."
...
if argv[2]=='1':
        ...
        outputsuffix="/rfMRI_REST1_LR/YEO"
else:
        suffix  = "/rfMRI_REST2_LR/rfMRI_REST2_LR_hp2000_clean.nii.gz"
        outputsuffix="/rfMRI_REST2_LR/YEO"
...
display=nlplt.plot_matrix(correlation_matrix_1, figure=(10, 9) , labels=[i for i in range(17)],
                     vmax=1.0, vmin=-1.0, reorder=True)
...
f3=open("../nilearn_data/yeo_2011/Yeo_JNeurophysiol11_MNI152/Yeo2011_17Networks_ColorLUT.txt","r")
lines=f3.readlines()
for i in lines:
  f1.write(i+"\n")
f1.close()
